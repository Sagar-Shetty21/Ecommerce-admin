...
const Colors = ({setInactive, setVarients, varients}) => {
  ...
  const deleteColorVarient = (indexToRemove) => {
  ...
  return (
    <div className="size-details-input-container">
        <div className="top-bar-title-and-cancel">
            <label>Add color varients</label>
        ...
        <form className="new-varient-input-container" onSubmit={(e) => handleAddVarient(e)}>
            <input type="text" placeholder="color name" required value={name} onChange={(e) => setName(e.target.value)} />
            <input type="color" placeholder="color" required value={color} onChange={(e) => setColor(e.target.value)} />
            ...
            {varients.map((item, index) => {
                return (
                    <div className="size-varient-card" key={index}>
                        ...
                        <div className="remove-varient-btn" onClick={() => deleteColorVarient(index)}>
